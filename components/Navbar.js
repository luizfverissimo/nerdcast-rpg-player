  ...
  return (
    <nav className='w-full z-0 flex justify-center bg-gradient-to-b from-[rgba(0,0,0,0.7)] py-4'>
      ...
      <div className='flex justify-center items-center'>
        <a className="font-oswald text-base text-theme-white underline transition-all transform hover:-translate-y-1" rel="external" href="https://lfverissimo.com" target="_blank" rel="noopener">
          LF Verissimo Portfolio
        </a>
        <a  rel="external" href="https://github.com/luizfverissimo" target="_blank" rel="noopener">
          <svg
            className='ml-2 fill-current text-theme-white transition-all transform hover:-translate-y-1 '
            width='22'
            height='22'
            viewBox='0 0 30 30'
            fill='none'
